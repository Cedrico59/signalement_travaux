...
// modifiez si besoin
  ...
  let map;
  let reports = [];
  window.showArchives = false; //  mode affichage ARCHIVES
...
//  Layer spcial pour affichage ARCHIVES (vite les erreurs addLayer)
      ...
      if (isAdmin() && r._archived) {
        ...
        restoreBtn.onclick = async (ev) => {
          ...
          try {
            ...
            console.warn("Restauration serveur choue", e);
...
//  Fix robuste: bouton Archives dans HTML
document.addEventListener("DOMContentLoaded", () => {
  const btn = document.getElementById("toggleArchivesBtn");
  if (!btn) {
    console.warn(" toggleArchivesBtn introuvable");
    return;
  }
  btn.style.display = "inline-flex";
  console.log(" Bouton Archives actif");
